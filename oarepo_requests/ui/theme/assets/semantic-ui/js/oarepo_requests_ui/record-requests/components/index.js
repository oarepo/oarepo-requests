...
export { RequestModal, RequestModalContent } from "@js/oarepo_requests_common";
...
export { RequestsPerCategory } from "./RequestsPerCategory";
export { CreateRequestButton } from "./CreateRequestButton";
