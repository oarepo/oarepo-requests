    ...
    for request_type in current_request_type_registry:
        ...
        for generator in creators:
            ...
            if autorequest in set(needs):
                ...
                request_item = current_oarepo_requests_service.create(system_identity, data=data,
                                                                      request_type=request_type.type_id, topic=record,
                                                                      creator=creator_ref, uow=uow, *args, **kwargs)
