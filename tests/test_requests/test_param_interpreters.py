...
def test_receiver_param_interpreter(
    ...
    print(type(current_requests.requests_resource.service), file=sys.stderr)  # noqa
    print(type(current_requests.requests_resource.service.config), file=sys.stderr)  # noqa
    print(type(current_requests.requests_resource.service.config).__mro__, file=sys.stderr)  # noqa
    print(current_requests.requests_resource.service.config.search.params_interpreters_cls, file=sys.stderr)  # noqa
